const { tools } = require("./libs/common");
  ...
  module.exports._n = {
    ...
    fillNumStringWithZero : require("./libs/fp/fillNumStringWithZero").fillNumStringWithZero,
...
module.exports.ProgressBar = require("./libs/single/ProgressBar").ProgressBar;