...
exports.joinLines = exports.expandToLine = exports.splitIntoLines = exports.transpose = exports.transposeSelections = exports.transposeCharacters = exports.getCommandsSplitIntoLines = exports.getCommandsTranspose = void 0;
const vscode = require("vscode");
const helperFunctions_1 = require("../helperFunctions");
// Commands
// ========
function getCommandsTranspose() {
    return vscode.commands.registerTextEditorCommand("shone.sing.lone.transpose", transpose);
}
exports.getCommandsTranspose = getCommandsTranspose;
function getCommandsSplitIntoLines() {
    return vscode.commands.registerTextEditorCommand("shone.sing.lone.splitIntoLines", splitIntoLines);
}
...
//# sourceMappingURL=Commands.Combine%20copy.js.map